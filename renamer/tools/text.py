...
class TEXT:
    ...
    UPLOAD_SUCESS = f"Thanks for using [me](https://t.me/tobot_update)"
...
** Channel:** [TOBOT UPDATE](https://t.me/tobot_update)

** Group:** [BOT SUPPORT](https://t.me/tobotupdate)
"""
...
I am a telegram renamer with permanent thumbnail you need to join[ @tobot_update ]for use this bot.
